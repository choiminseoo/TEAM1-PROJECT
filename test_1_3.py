...
headers = ["제목", "국가", "장르", "평점", "개봉일", "관객수", "감독", "출연", "OTT"]   ## 헤더 모음
        ...
        while True :
            ...
            for i in range(1, 9) :
                try :    ## 셀레니움으로 영화 제목 가져온 후 리퀘스트로 영화 정보 가져오기
                    ...
                    for i in range(1,6) :
                        try :
                            if html_tree.xpath("//*[@id=\"main_pack\"]/div[2]/div[2]/div[2]/div/div[1]/dl/div["+str(i)+"]/dt/text()")[0] == "평점" :
                                avgScore = html_tree.xpath("//*[@id=\"main_pack\"]/div[2]/div[2]/div[2]/div/div[1]/dl/div["+str(i)+"]/dd/text()")[0]
                                break
                        except :
                            break
                    ...
                    for i in range(1,6) :
                        try :
                            if html_tree.xpath("//*[@id=\"main_pack\"]/div[2]/div[2]/div[2]/div/div[1]/dl/div["+str(i)+"]/dt/text()")[0] == "개봉" or "출시일" :
                                releaseDate = html_tree.xpath("//*[@id=\"main_pack\"]/div[2]/div[2]/div[2]/div/div[1]/dl/div["+str(i)+"]/dd/text()")[0]
                                break
                        except :
                            break
                    ...
                    for i in range(1,6) :
                        try :
                            if html_tree.xpath("//*[@id=\"main_pack\"]/div[2]/div[2]/div[2]/div/div[1]/dl/div["+str(i)+"]/dt/text()")[0] == "관객수" :
                                audience = html_tree.xpath("//*[@id=\"main_pack\"]/div[2]/div[2]/div[2]/div/div[1]/dl/div["+str(i)+"]/dd/text()")[0]
                                break
                        except :
                            break
                    ...
                    print(movieName, movieCountry, movieGenre, avgScore, releaseDate, audience, director, actors)
                    movieInfo = [movieName, movieCountry, movieGenre, avgScore, releaseDate, audience, director, actors]
